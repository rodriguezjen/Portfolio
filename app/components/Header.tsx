...
const toggleNav = (nav:string) => {
  ...
  return (
    <div className='h-20 w-full bg-custom-black flex justify-center'>
        <div className='flex space-x-4 pt-5 text-gray-300'>
            ...
            <button className='hover:text-custom-orange ease-in-out duration-150 focus:text-custom-black border-2 border-transparent focus:border-white focus py-1 px-3 rounded-full focus:bg-custom-orange' onClick={()=>toggleNav("portfolio")}>Portfolio</button>
            <button className='hover:text-custom-orange ease-in-out duration-150 focus:text-custom-black border-2 border-transparent focus:border-white focus py-1 px-3 rounded-full focus:bg-custom-orange' onClick={()=>toggleNav("contact")}>Contact</button>
        </div>
    </div>
  )
}
